...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", disabled, ...props }, ref) => (
    <button
      ref={ref}
      className={clsx(
        "inline-flex items-center justify-center font-mono text-xs tracking-wider uppercase focus:outline-none focus:ring-1 focus:ring-hm-muted disabled:opacity-50 disabled:pointer-events-none",
